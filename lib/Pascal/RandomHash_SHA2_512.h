...
inline void _RandomHash_SHA2_512(RH_StridePtr roundInput, RH_StridePtr output, bool is384)
{
...
void RandomHash_SHA2_512(RH_StridePtr roundInput, RH_StridePtr output)
{
    _RandomHash_SHA2_512(roundInput, output, false);
}


void RandomHash_SHA2_384(RH_StridePtr roundInput, RH_StridePtr output)
{
    _RandomHash_SHA2_512(roundInput, output, true);
}
