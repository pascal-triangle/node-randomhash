...
void SHA3_512_Transorm(const uint64_t *data, uint64_t* state, const size_t BlockSize)
{
...
void _RandomHash_SHA3_512(RH_StridePtr roundInput, RH_StridePtr output, uint64_t hashsize)
{
