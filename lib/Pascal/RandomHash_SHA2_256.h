...
void RandomHash_SHA2_256(RH_StridePtr roundInput, RH_StridePtr output)
{
    ...
    //RandomHash_MD_BASE_MAIN_LOOP(SHA2_256_BLOCK_SIZE, SHA2_256_RoundFunction, ReverseBytesUInt64);
    {
