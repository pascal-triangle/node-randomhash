...
static const uint32_t RH_ALIGN(64) blake2s_IV[8] = {
	0x6A09E667UL, 0xBB67AE85UL, 0x3C6EF372UL, 0xA54FF53AUL,
	0x510E527FUL, 0x9B05688CUL, 0x1F83D9ABUL, 0x5BE0CD19UL
};

static const uint8_t RH_ALIGN(64) blake2s_sigma[10][16] = {
...
void RandomHash_blake2s(RH_StridePtr roundInput, RH_StridePtr output)
{
	...
	blake2s_final_SSE2( &S, RH_STRIDE_GET_DATA(output), BLAKE2S_OUTBYTES );
