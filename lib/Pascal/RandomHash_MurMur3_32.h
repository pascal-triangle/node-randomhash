...
const uint32_t MurmurHash3_x86_32_c1 = 0xcc9e2d51;
const uint32_t MurmurHash3_x86_32_c2 = 0x1b873593;
const uint32_t MurmurHash3_x86_32_c3 = 0xe6546b64;
const uint32_t MurmurHash3_x86_32_c4 = 0x85ebca6b;
const uint32_t MurmurHash3_x86_32_c5 = 0xc2b2ae35;
...
inline void MurmurHash3_x86_32_Update_16(__m128i chunk128, uint32_t len, MurmurHash3_x86_32_State* state)
{
    RH_ASSERT(len < S32_Max);
    RH_ASSERT(state->idx != 0xDEADBEEF)
...
uint32_t MurmurHash3_x86_32_Fast(const void * key, int len, uint32_t h1)
{
